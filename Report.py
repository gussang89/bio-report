...
import io
from docx import Document  # 워드 파일 생성을 위한 라이브러리
...
st.caption("AI가 최신 논문의 초록을 모두 읽고 분석합니다. 완료 후 Word 파일로 다운로드할 수 있습니다.")
    ...
    with st.spinner("논문을 수집하고, AI가 심층 리포트를 작성 중입니다. 잠시만 기다려주세요..."):
        ...
        if not papers:
            ...
            st.download_button(
                ...
                data=docx_file,
                file_name=f"Bio_Tech_Report_{datetime.now().strftime('%Y%m%d')}.docx",
